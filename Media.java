...
public class Media implements Comparable<Media>{
	...
	/**
	 * Compares user provided object against the media objects.
	 * 
	 * @param otherMedia  The media object that will be compared against the media lists. The media object is made of user provided info.
	 *
	 */
	...
	/**
	 * This class compares the Year string of different media objects and implements Comparator. 
	 *
	 */
	static class YearComparator implements Comparator<Media>{

		/**
		 * Compares the years of two media objects
		 * 
		 * @param med1   Media object from the list to be compared. 
		 * @param med2   2nd Media object that will be compared.
		 * 
		 * @return  Returns number greater than 0 if med2's year is greater than med1's year.  Returns number less than 0 if med1's year is less than med2's year. Returns 0 if both years are the same.
		 */
