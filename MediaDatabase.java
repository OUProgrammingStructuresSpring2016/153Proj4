...
public class MediaDatabase {
	...
	/**
	 * Adds media to the Movie or tv database.
	 * 
	...
	public List<Media> searchMovieTitleExact(String title) {
		...
		int indexOfMovie = Collections.binarySearch(movieDatabase, new Movie(title, "", ""));
	 ...
	 */
	public List<Media> searchTVTitlePartial(String title, boolean includeEpTitles) {
	...
	/**
	 * Clears the results of the resultList.
	 */
	...
	/**
	 * A To-String method for the resultList.
	 * 
	 * @return Gives a String of the resultList.
	 */
	 ...
	 * @param fileName  Name of the file that is put into the FileWriter.
	 * @param textToOutput  File that is written out by the BufferedWriter.
	 * 
	 * @throws IOException 
	 * 
	 */
	...
	/**
	 * Sorts the movie and tv database. 
	 */
