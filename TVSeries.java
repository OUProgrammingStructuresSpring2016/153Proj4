...
public class TVSeries extends Media{
	...
	/**
	 * Adds a new episode to the Episodes list.
	...
	/**
	 * Searches the episodes list for a partial title of an episode.
	 * 
	 * @param title  The partial title that will be searched for.
	 * @return  A result list of episodes that are partial matches to the  "title" parameter.
	 */
	...
	/**
	 * Searches the episodes list for an exact match to the "title" parameter.
	 * 
	 * @param title  Exact title of an episode.
	 * @return   Gives an arraylist of exact matches to the title parameter.
	 */
...
/**
 * Searches for the episode by year.
 * 
 * @param year  The episode's year
 * @return Gives a list of episodes that have a year matching the year parameter.
 */
